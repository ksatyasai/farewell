...
<html lang="en">  
<head>  
  <title>20-CME FAREWELL Data</title>  
  <meta charset="utf-8">  
      ...
      ?>
        ...
        ?>
         <tr><td ></td>     
          ...
          <?php
          $sql1="select sum(Amount) from `student data`";
...
<?php 
  ...
  echo "<script>alert('Login Not Successfull');window.location.href='index.php'<script/>";
}    
?>
